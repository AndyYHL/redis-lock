...
public class HttpClientUtil {
     ...
     * @throws Exception
     */
    public HttpClientResult doGet(String url) throws IOException, URISyntaxException {
     ...
     * @throws Exception
     */
    public HttpClientResult doGet(String url, Map<String, String> params) throws IOException, URISyntaxException {
     ...
     * @throws Exception
     */
    public HttpClientResult doGet(String url, Map<String, String> headers, Map<String, String> params) throws IOException, URISyntaxException {
        // 创建httpClient对象
     ...
     * @throws IOException
     */
    private static BufferedImage getHttpClientResultBufferedImage(CloseableHttpResponse httpResponse,
                                                                  CloseableHttpClient httpClient, HttpRequestBase httpMethod) throws IOException {
        // 执行请求
        httpResponse = httpClient.execute(httpMethod);
        // 获取返回结果
     ...
     */
    public HttpClientResult uploadFileHttpClientResult(String url, String fileKey, String fileName, InputStream file) throws IOException {
        CloseableHttpClient httpClient = HttpClients.createDefault();
        HttpPost httpPost = new HttpPost(url);
     ...
     */
    public HttpClientResult doPost(String url, String regJson) throws IOException {
        CloseableHttpClient httpClient = HttpClients.createDefault();
        HttpPost httpPost = new HttpPost(url);
     ...
     *
     * @param url     请求地址
     * @param regJson 请求的JSON
     * @return 返回信息
     * @throws IOException
     */
    public BufferedImage doPostImg(String url, String regJson) throws IOException {
        CloseableHttpClient httpClient = HttpClients.createDefault();
        HttpPost httpPost = new HttpPost(url);
        ...
        try {
            return getHttpClientResultBufferedImage(httpResponse, httpClient, httpPost);
        } finally {
            release(httpResponse, httpClient);
        }
    }
